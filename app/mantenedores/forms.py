...
class DivisionForm(FlaskForm):
    ...
    zona_distribucion = QuerySelectField('Zona de Distribución', query_factory=choice_Zona_Distribucion, allow_blank=True, blank_text='')
    zona_simulcasting = QuerySelectField('Zona de Simulcasting', query_factory=choice_Zona_Simulcasting, allow_blank=True, blank_text='')
    zona_participacion = QuerySelectField('Zona de Partipación', query_factory=choice_Zona_Participacion, allow_blank=True, blank_text='')
    tipo_asociado = QuerySelectField('Tipo Asociado', query_factory=choice_Asociado, allow_blank=True, blank_text='')
    categoria = QuerySelectField('Categoria de la División', query_factory=choice_Categoria, allow_blank=True, blank_text='')
    encargado = QuerySelectField('Encargado', query_factory=choice_Encargado, allow_blank=True, blank_text='')
    boton = SubmitField('Ingresar')
